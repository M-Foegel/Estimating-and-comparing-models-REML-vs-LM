---
title: "Estimating and comparing models : REML vs ML"
...
#make sure lmerTest is not loaded, we want to show the difference bf and after loading it
if("package:lmerTest" %in% search()) detach("package:lmerTest", unload=TRUE) 
```
